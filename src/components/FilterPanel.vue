<template>
  <el-card shadow="hover" style="width: 50vw;margin: 0 auto">
    <div style="width:100%">
      ...
      <el-button plain style="width:100%;margin-bottom:16px" type="danger" @click="$emit('clear')">🗑️ 清空过滤器
      </el-button>
      <div style="width:100%">
        ...
        <div style="display:flex;flex-wrap:wrap;margin-top:8px">
          <el-tag v-for="(expr, index) in exampleExpressions" :key="index" effect="plain"
      ...
      <div style="width:100%;margin-bottom:16px">
        ...
        <el-input :model-value="modelValue" clearable
                  placeholder="jmespath表达式，如 users[].{id:id,name:name}" @update:model-value="$emit('update:modelValue', $event)">
          <template #prefix><span
              style="font-family:Monaco,Menlo,monospace;font-weight:600;color:#f59e0b;font-size:1.1rem">λ</span>
          </template>
        </el-input>
      </div>
    </div>
